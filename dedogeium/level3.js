...
const dialogueVoiceMap = {
    ...
    bad: { characterKey: "level3-enemy", team: "enemy" },
};
...
const enemy_max_health = 400;
let enemy_health = 400;
let max_health = 500;
let health = 500;
let damage = 20;
let enemy_damage = 25;
...
const dialogue = [
    ...
    { speaker: 'bad', text: "Oh I know your brother. He is my best friend." },
    { speaker: 'good', text: "Why does everybody know him?May you give me something?" },
    { speaker: 'bad', text: "He is a good fighter, it will be a hard battle between you 2. Only if you defeat me first." },
...
const postDialogueLose = [
    { speaker: 'bad', text: "Looks like fear wins today." },
    { speaker: 'good', text: "Not for long. I will come back ready." },
    { speaker: 'bad', text: "Then train until you can prove it." }
];
const postDialogueWin = [
    { speaker: 'bad', text: "I did not expect you to beat me." },
    { speaker: 'good', text: "You should stop trusting fear to make your choices." },
    { speaker: 'bad', text: "Maybe I should. Take your prize and move on." }
];
let postIndex = 0;
