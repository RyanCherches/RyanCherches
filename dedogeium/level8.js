...
const rarityWeights = [15, 10, 25, 44.9, 10, 0.1];
...
const enemy_max_health = 2000;
let enemy_health = 2000;
let max_health = 500;
let health = 500;
let damage = 20;
let enemy_damage = 200;
...
const dialogue = [
    { speaker: 'good', text: "What the. Is that what I think it is?" },
    { speaker: 'bad', text: "Oh yeah. You are so dead." },
...
const postDialogue = [
    { speaker: 'good', text: "I am just a little tired from my other battles. I need some sleep and better gear. And also the fact that you are literally like 20 doges in one." },
    { speaker: 'bad', text: "Exuces. Exuces. Exuces." },
    { speaker: 'good', text: "You got me, but I will win sometime." },
    { speaker: 'bad', text: "Sure buddy. Then see you soon. That luck didn't work" }
];
let postIndex = 0;
...
async function battleLoop() {
    ...
    if (hasWon && currentCompletedLevel < 9) {
        localStorage.setItem("completedLevel", 9);
    }
